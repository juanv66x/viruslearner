...
#' @param viralvars Vector of viral load variables.
#' @param logbase Logarithm base for viral load transformations.
...
#' }
vl_stack <- function(outcome, traindata, viralvars, logbase, seed, repetitions, gridsize) {
  set.seed(seed) 
  stacks::stacks() |>
