#' Fit and Evaluate Stacked Ensemble Model for Viral Load Outcome
#'
...
#' }
vl_fit <- function(outcome, traindata, viralvars, logbase, seed, repetitions, gridsize, testdata, predicted) {
  set.seed(seed) 
  stacks::stacks() |>
